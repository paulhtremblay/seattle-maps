...
<qgis simplifyLocal="1" styleCategories="AllStyleCategories" readOnly="0" version="3.10.4-A Coruña" maxScale="0" labelsEnabled="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08" simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyMaxScale="1">
  <flags>
  ...
  <DiagramLayerSettings obstacle="0" placement="0" linePlacementFlags="18" dist="0" zIndex="0" priority="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
