...
<qgis version="3.10.4-A Coruña" simplifyDrawingTol="1" styleCategories="AllStyleCategories" maxScale="0" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" simplifyAlgorithm="0" simplifyDrawingHints="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" minScale="1e+08">
  <flags>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" name="0">
        <layer enabled="1" locked="0" pass="0" class="SVGFill">
          ...
          <prop k="svgFile" v="svg/grassy-high-fill_25k.svg"/>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="line" name="@0@0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="Point" fontLetterSpacing="0" textOpacity="1" fieldName="name" namedStyle="Regular" fontItalic="0" blendMode="0" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontSize="6" fontUnderline="0" textColor="0,0,0,255" fontWeight="50" fontFamily="Ubuntu" multilineHeight="1" fontKerning="1" useSubstitutions="0" fontCapitals="0" textOrientation="horizontal" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0">
        <text-buffer bufferSize="1" bufferJoinStyle="128" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferOpacity="1" bufferSizeUnits="MM" bufferDraw="0" bufferBlendMode="0"/>
        <background shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetY="0" shapeBlendMode="0" shapeOffsetUnit="MM" shapeSizeX="0" shapeJoinStyle="64" shapeSizeUnit="MM" shapeOpacity="1" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRotationType="0" shapeBorderWidth="0" shapeRotation="0" shapeBorderColor="128,128,128,255" shapeFillColor="255,255,255,255" shapeDraw="0" shapeSVGFile="" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeSizeType="0" shapeSizeY="0" shapeOffsetX="0" shapeRadiiY="0">
        ...
        <shadow shadowOffsetAngle="135" shadowOffsetDist="1" shadowOffsetUnit="MM" shadowOffsetGlobal="1" shadowColor="0,0,0,255" shadowUnder="0" shadowRadius="1.5" shadowRadiusUnit="MM" shadowRadiusAlphaOnly="0" shadowOpacity="0.7" shadowScale="100" shadowBlendMode="6" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowDraw="0" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0"/>
        <dd_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
      ...
      <text-format autoWrapLength="0" addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" wrapChar="" plussign="0" multilineAlign="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" placeDirectionSymbol="0" rightDirectionSymbol=">" decimals="3"/>
      <placement overrunDistance="0" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" layerType="PolygonGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" placement="0" placementFlags="10" offsetUnits="MM" geometryGenerator="" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" xOffset="0" distUnits="MM" centroidInside="0" preserveRotation="1" geometryGeneratorType="PointGeometry" dist="0" centroidWhole="0" rotationAngle="0" priority="5" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0"/>
      <rendering scaleVisibility="0" minFeatureSize="0" mergeLines="0" obstacle="1" labelPerPart="0" drawLabels="1" displayAll="0" obstacleFactor="1" upsidedownLabels="0" maxNumLabels="2000" zIndex="0" scaleMax="0" fontLimitPixelSize="0" scaleMin="0" obstacleType="0" limitNumLabels="0" fontMinPixelSize="3" fontMaxPixelSize="10000"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <layerOpacity>0.407</layerOpacity>
  ...
  <DiagramLayerSettings zIndex="0" showAll="1" linePlacementFlags="18" dist="0" priority="0" obstacle="0" placement="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
