...
<qgis version="3.10.4-A Coruña" simplifyDrawingTol="1" styleCategories="AllStyleCategories" maxScale="0" readOnly="0" simplifyMaxScale="1" simplifyLocal="1" simplifyAlgorithm="0" simplifyDrawingHints="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" minScale="1e+08">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      ...
      <text-format autoWrapLength="0" addDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" wrapChar="" plussign="0" multilineAlign="3" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" placeDirectionSymbol="0" rightDirectionSymbol=">" decimals="3"/>
      <placement overrunDistance="0" repeatDistanceUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" layerType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" placement="0" placementFlags="10" offsetUnits="MM" geometryGenerator="" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" xOffset="0" distUnits="MM" centroidInside="0" preserveRotation="1" geometryGeneratorType="PointGeometry" dist="0" centroidWhole="0" rotationAngle="0" priority="5" yOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0"/>
